...
public class BalanceCommandTest implements WithAssertions {
    ...
    private DepositFundsCommand secondDepositFundsCommand = depositFundsCommand(ANOTHER_ACCOUNT_ID, 9, timeOfFirstEvent.plusMinutes(5));
    ...
    public void compareToTest() {
        ...
        assertThat(firstWithdrawFundsCommand.compareTo(secondDepositFundsCommand)).isEqualTo(1);
    }
